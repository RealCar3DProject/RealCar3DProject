...
{
	Vector3_t2243707580_marshaled_pinvoke ___m_Intersection_0;
	Vector3_t2243707580_marshaled_pinvoke ___m_Normal_1;
	Vector3_t2243707580_marshaled_pinvoke ___m_Velocity_2;
	int32_t ___m_ColliderInstanceID_3;
};
// Native definition for marshalling of: UnityEngine.ParticleCollisionEvent
struct ParticleCollisionEvent_t248228720_marshaled_com
{
	Vector3_t2243707580_marshaled_com ___m_Intersection_0;
	Vector3_t2243707580_marshaled_com ___m_Normal_1;
	Vector3_t2243707580_marshaled_com ___m_Velocity_2;
	int32_t ___m_ColliderInstanceID_3;
};
